...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _APIConsumer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./APIConsumer.js */ \"./src/modules/APIConsumer.js\");\n\n\nconst updateHTML = (container, scores) => {\n  container.innerHTML = '';\n\n  scores.forEach((entry) => {\n    const listItem = document.createElement('li');\n    listItem.textContent = `${entry.user}: ${entry.score}`;\n    container.appendChild(listItem);\n  });\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (scoreList) => {\n  scoreList.list = await (0,_APIConsumer_js__WEBPACK_IMPORTED_MODULE_0__.fetchScores)();\n  updateHTML(scoreList.container, scoreList.list);\n});\n\n\n//# sourceURL=webpack://leaderboard/./src/modules/DOMFunctions.js?");
